 ...
 */
getUserByFilter = async (filter, attributesToExclude = [], extraAttributesToInclude = []) => {
    ...
    attributesToInclude = attributesToInclude.filter(attr => !attributesToExclude.includes(attr));
